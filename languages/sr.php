...
function lang($phrase){
    static $lang = array(
        ...
        'ABOUT_ME' => 'O meni:',
        'ABOUT_TEXT1' => 'Zovem se David Šili i bavim se razvojem internet aplikacija u PHP-u. Posebno volim da razvijam mini-ERP rešenja, kao i CSM aplikacije, a rado se pozabavim i bilo kojim drugim projektom koji se ponudi.</p><p class="veci_tekst">Tokom poslednje četiri godine razvijao sam jednostavne edukativne aplikacije, kao i složena mini-ERP rešenja za pojedince kao i za firme.',
